...
// import {
//   Building2, User, Phone, Radio, Bookmark,
//   ShieldCheck, Star, FolderOpen, FileText, X, Save,
// } from "lucide-react";
...
//                 router.push("/sales/lead");
//               }}
//               className="px-6 py-2 rounded-xl border border-gray-200 text-sm text-gray-600 hover:bg-gray-50 transition flex items-center gap-2"
//             >
//               <X size={15} /> Cancel
//             </button>
...
//               className={`px-6 py-2 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-600 hover:to-violet-800 text-white text-sm font-semibold transition-all shadow-sm hover:shadow-md flex items-center gap-2 ${isSubmitting ? "opacity-70 cursor-not-allowed" : ""}`}
//             >
//               {isSubmitting ? (
//                 <svg
